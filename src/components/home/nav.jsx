...
export default function Nav() {
  ...
  const toggleDropdown = () => {
    ...
    console.log('toggleDropdwon executed')
    dropdownOpen === 'show'?setDropdownOpen(''):setDropdownOpen('show');
      ...
      <header className="contactus-navbar">
        <nav className="contactus-nav-container">
          ...
          <ul className={`nav-menu ${isOpen ? "active" : ""}`} id="nav-links">
            ...
            >
              <span className="nav-link" onClick={toggleDropdown}>Company</span>
              <ul className={`dropdown-menu ${dropdownOpen}`} >
                <li>
                  <Link
                    to="/about"
